...
public class Add_Isotope_AlertDialog {
    ...
    // Constructor
    public Add_Isotope_AlertDialog(Context myContext, RESPONSE myResponse){
    ...
    private void buildAlertDialog(){
        ...
        final View myDialogView = myInflater.inflate(R.layout.dialogbox_add_isotope,null);
        ...
        input1_edittext.setInputType(InputType.TYPE_TEXT_VARIATION_PERSON_NAME);
        input2_edittext.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL);
